...
# vit_checkpoint = torch.load('pytorchToDjangoTest/vit_model_0806.pth', map_location=torch.device('cpu'))
# deit_checkpoint = torch.load('pytorchToDjangoTest/deit_model_0806.pth', map_location=torch.device('cpu'))
#
