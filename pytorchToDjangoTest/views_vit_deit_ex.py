...
#     deit_pred = torch.argmax(deit_output, dim=1).item()
#
#     true_label = 0  # Example true label
#
#     vit_correct = vit_pred == true_label
#     deit_correct = deit_pred == true_label
#
#     vit_accuracy = int(vit_correct)
#     deit_accuracy = int(deit_correct)
#
#     return {'vit_prediction': vit_pred,
#             'deit_prediction': deit_pred,
